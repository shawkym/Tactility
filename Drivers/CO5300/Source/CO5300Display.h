...
class CO5300Display final : public EspLcdDisplay {
...
public:
    ...
    explicit CO5300Display(std::unique_ptr<Configuration> inConfiguration) :
    ...
    std::string getDescription() const override { return "CO5300 display"; }
